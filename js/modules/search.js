...
export const SearchModule = {
  ...
  executeSearch: async function() {
    ...
    try {
        const [eventSnap, scheduleSnap, journalSnap, taskSnap] = await Promise.all([
        ...
        if (targetDatesObj === 'ALL') {
            const allSet = new Set([...Object.keys(eventMap), ...Object.keys(scheduleMap), ...Object.keys(journalMap)]);
        ...
        // 🌟 [핵심 변경] 메모 클릭 시 window.targetMemoId를 기억하고 이동하도록 수정!
