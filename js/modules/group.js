...
import { dbAPI, auth } from '../firebase.js';
...
export const GroupManager = {
    ...
    openModal: async function() {
        ...
        try {
            // DB에서 내가 속한 그룹 목록 불러오기
            this.myGroups = await dbAPI.loadMyGroups();
            
            // 데이터 로드 후 실제 HTML로 교체
        ...
        return `
            <div style="display:flex; flex-direction:column; gap:20px; max-height:65vh; overflow-y:auto; padding-right:5px;">
                ...
                <div>
                    ...
                    <div id="group-list-container" style="display:flex; flex-direction:column; gap:10px; min-height:150px;">
                        <!-- 자바스크립트로 렌더링 됨 -->
                    </div>
                </div>
...
// 글로벌 스코프에 등록하여 UI(HTML)에서 호출할 수 있도록 함
