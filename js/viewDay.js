              ...
              <table style="text-align: center;">
                <thead>
                  <tr>
                    ...
                    <th>📝 수업 메모</th>
                    <!-- 🌟 [핵심 변경] 비고 헤더에 조사표 추가 버튼 하나만 배치 -->
                    <th style="width: 25%; position:relative;">📌 비고 
                        <button onclick="window.openSurveyModal ? window.openSurveyModal('${dateStr}') : alert('조사표 기능이 연결되지 않았습니다.')" style="margin-left:8px; padding:2px 8px; background:#e0f2fe; color:#0284c7; border:1px solid #7dd3fc; border-radius:4px; font-size:0.75rem; cursor:pointer; font-weight:bold; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">+ 조사표</button>
                    </th>
                  </tr>
                </thead>
