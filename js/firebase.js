...
import { getFirestore, collection, doc, getDoc, getDocs, addDoc, updateDoc, deleteDoc, setDoc, query, orderBy } from "firebase/firestore";
...
// 🌟 [핵심 롤백] 오프라인 캐시 충돌(로딩 멈춤)을 해결하기 위해 기본 엔진으로 원상 복구했습니다!
export const db = getFirestore(app);
export const auth = getAuth(app);
export const storage = getStorage(app);

console.log("🔥 Firebase Modular SDK(v10)가 성공적으로 연결되었습니다. (캐시 충돌 픽스 완료)");
...
// 3. 최신 문법(getDoc, setDoc 등)이 적용된 dbAPI
export const dbAPI = {
    loadMemos: async () => {
        try {
