...
export class WeekView extends BaseView {
  ...
  async renderViewer() {
    ...
    const wsSelectHtml = `<select onchange="window.weekViewInstance.changeScheduleWorkspace(this.value)" style="padding:4px 8px; border-radius:6px; border:1px solid #cbd5e1; font-weight:bold; color:#0f766e; background:#f0fdf4; outline:none; cursor:pointer;">${wsOptions}</select>`;
