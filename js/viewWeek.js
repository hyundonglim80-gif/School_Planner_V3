...
              
              // 💡 전역 함수를 통해 안전하게 이벤트 연결 (문법 에러 방지)
...
// 💡 [추가] 주간/월간/연간 에디터의 라벨 클릭을 처리하는 전용 전역 함수 (상호 배타 로직 포함)
...
        }
        
        // 2. 완료(이월) 속성 라벨을 누른 경우 -> 기존의 기간 라벨을 모두 제거 (상호 배타)
