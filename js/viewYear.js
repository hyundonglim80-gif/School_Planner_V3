...
import { formatDate, getEventLabels, isRedDay } from './core/utils.js';
...
export class YearView extends BaseView {
  ...
  save() {
    ...
    // 🌟 [핵심 변경] await 없이 백그라운드로 안전하게 던지기
    snapshot.forEach(item => {
        ...
        dbAPI.saveSchedule(item.dateStr, item.periodsData).catch(e => console.warn(e));
    });
  }
}
